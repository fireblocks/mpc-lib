...
COSIGNER_EXPORT commitments_status commitments_ctx_commitment_update(commitments_ctx_t *ctx, const void *data, uint32_t data_len);
/* Creates final commitment, and frees the commitment context */
COSIGNER_EXPORT commitments_status commitments_ctx_commitment_final(commitments_ctx_t *ctx, commitments_commitment_t *commitment);
