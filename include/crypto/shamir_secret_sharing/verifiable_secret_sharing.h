 ...
 * ids must be an array of size n */
...
/* Gets a specific share (zero indexed) from initialized shares */
...
/* Gets the ID of a specific share (zero indexed) from initialized shares */
...
/* Gets a specific share and its zero knowledge proof (zero indexed) from initialized shares */
...
/* Gets the threshold of of the schema e.g. t, -1 is returned if shares are invalid */
 ...
 * if shares_count is less than the needed t shares wrong secret will be generated */
...
/* Verifies that share proof for share id id, is a valid share for polynom represented by coefficient_proofs
...
/* Verifies the proofs commitment (SHA256) */
